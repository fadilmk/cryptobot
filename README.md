# cryptobot
**crypto club official price checker bot**
...
<p align="left">
  <a href="https://heroku.com/deploy?template=https://github.com/fadilmk/cryptobot">
...
```
git clone https://github.com/fadilmk/cryptobot
cd cryptobot
